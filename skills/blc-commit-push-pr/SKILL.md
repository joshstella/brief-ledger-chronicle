...
5. Write a commit message that captures the *why*, not just the what. One concise subject line; add a short body if the change needs context. Run the subject and body through the `blc-ste-writing` skill (STE-flavored mode) before committing. End with:
